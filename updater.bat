...
set "my_repo=https://github.com/thanglc304/spiderid_app"
...
@REM copy repo/utils and repo/main.py to replace current utils and main.py
echo Copying utils/*.* ...
xcopy /y /q /e "%my_dir%\utils" "%cd%\utils"
